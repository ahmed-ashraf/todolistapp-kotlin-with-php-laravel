...
class AddEditTaskViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _taskUpdatedEvent = MutableLiveData<com.todoapp.todoapp.Event<Unit>>()
    val taskUpdatedEvent: LiveData<com.todoapp.todoapp.Event<Unit>> = _taskUpdatedEvent
    ...
    fun saveTask() {
        ...
        if (currentTitle == null || currentDescription == null) {
            _snackbarText.value = com.todoapp.todoapp.Event(R.string.empty_task_message)
            return
        }
    ...
    private fun createTask(newTask: Task) = viewModelScope.launch {
        ...
        _taskUpdatedEvent.value = com.todoapp.todoapp.Event(Unit)
    }
